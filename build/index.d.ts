...
export { generateEccKeyPair, generateRsaKeyPair, sign, signBytes, signBytesV2, verify, verifyString, verifyBytes, verifyBytesV2, encrypt, encryptBytes, encryptBytesV2, decrypt, decryptBytes, decryptBytesV2, validatePublicKey, CryptoError };
