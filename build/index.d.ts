...
export { generateEccKeyPair, generateRsaKeyPair, sign, signBytes, verify, verifyString, verifyBytesHelper, verifyBytes, encrypt, encryptBytesHelper, encryptBytes, decrypt, decryptBytes, validatePublicKey, CryptoError };
